...
/**
 * Reduced brand column for public recovery screens (forgot / reset).
 * No PipelineGraphic — identity only, not commercial login context.
 */
export function PublicAuthBrandPanel() {
  return (
    <Box
      position="relative"
      display="flex"
    ...
    >
      ...
      >
        ...
        <Text fontSize="md" lineHeight="tall" color="whiteAlpha.700">
