...
(`docs/product/pilot-validation-plan.md`). Complementa o Product Owner do Prospecta.
...
- classificação PLATFORM, WORKSPACE ou PILOT_SPECIFIC
...
- É PLATFORM, WORKSPACE ou PILOT_SPECIFIC?
...
7. **Classificação** — PLATFORM | WORKSPACE | PILOT_SPECIFIC
